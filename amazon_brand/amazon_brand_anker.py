...
#        ee.write(resp.text.replace('\n', '') + '\n')
    ...
    category_list = content.xpath('''//ul[@class="a-unordered-list a-horizontal a-size-small"]//span//a[contains(@class,"a-link")]/text()''')
...
def get_data():
    ...
    while 1:
        ...
        if redis_dict:
            ...
            print('队列已消耗完毕，退出')
            msg = '亚马逊品牌{}队列已消耗完毕，采集成功{}个'.format(brand_key,str(url_db.scard('amazon_brand_spider:successful_{}_list'.format(brand_key))))
            dingding(msg)
